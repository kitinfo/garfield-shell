...
int selectCashRegister(PGconn* db){
	static const char* QUERY_CASH_REGISTERS="SELECT cash_box_id, cash_box_name, location_name FROM garfield.cash_boxes JOIN garfield.locations USING (location_id)";
	unsigned i;
	char read_buffer[20];
